...
- **Included Folders**: Use regular expressions to sync only specific folders.
  - *Example (Inbox Only)*: `^INBOX$`
  - *Example (Inbox and Sent)*: `^INBOX$|^Sent`
...
*For issues with the Imapsync software itself, visit the [official imapsync documentation](https://imapsync.lamiral.info/FAQ.d/).*
