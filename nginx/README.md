...
[![Open your Home Assistant instance and show the App dashboard.](https://my.home-assistant.io/badges/supervisor_App.svg)](https://my.home-assistant.io/redirect/supervisor_App/?App=c1e285b7_nginx)
...
**[Report a Bug](https://github.com/FaserF/hassio-addons/issues/new?template=bug_report.yml&version_integration=0.0.1&log_information=Please+paste+the+App+log+output+here%3A%0A%0A)**
...
**[Request a Feature](https://github.com/FaserF/hassio-addons/issues/new?template=feature_request.yml&App_name=nginx)**
