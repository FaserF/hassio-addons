...
bashio::addon.print_banner() {
	...
	# Software version
	if [ -n "${WIKIJS_VERSION:-}" ]; then
		bashio::log.info "🔧 Wiki.js V3 (Beta) Version: ${WIKIJS_VERSION}"
	fi
	bashio::log.blue "-----------------------------------------------------------\n"
	...
	bashio::log.warning "⚠️  This is Wiki.js V3 (Beta) - not recommended for production!"
	bashio::log.warning "⚠️  For production use, please use the stable Wiki.js V2 addon."
