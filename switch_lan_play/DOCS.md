...
This is just the Client Software and NOT the Server Software. To use a lan-play server with Homeassistant OS, please have a look at my other App: [switch_lan_play_server](https://github.com/FaserF/hassio-addons/tree/master/switch_lan_play_server)
