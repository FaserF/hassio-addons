...
_show_app_banner() {
    ...
    local GITHUB_PATH="switch_lan_play"
...
bashio::log.info "   Check out the Switch LAN Play Server App:"
...
echo "If you want to install the latest lan-play client, please reinstall this App"
