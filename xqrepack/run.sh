...
_show_startup_banner() {
	...
	local VERSION
	VERSION="$(bashio::app.version 2>/dev/null || bashio::addon.version 2>/dev/null))"
...
if [[ "$firmware_name" == *"rm1800"* ]] || [[ "$firmware_name" == *"ax1800"* ]]; then
	...
	echo "If you tried to use it with a rm1800 image, do NOT flash the image and restart the App with the firmware_name rm1800 inside."
fi
