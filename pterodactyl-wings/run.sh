...
_show_app_banner() {
    ...
    local GITHUB_PATH="pterodactyl-wings"
...
if [ ! -f "$config_file" ]; then
	...
	if [ ! -f "$SHARED_CONFIG" ]; then
		...
		bashio::log.info "Ensure the Pterodactyl Panel App is installed and running."
...
if grep -q 'token: "example"' "$config_file"; then
	bashio::log.warning "-----------------------------------------------------------"
	bashio::log.warning " App is NOT configured!"
	...
	bashio::log.warning " The App will wait here until you restart it with a valid config."
	bashio::log.warning "-----------------------------------------------------------"
	sleep infinity
fi
