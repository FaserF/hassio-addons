...
**[Report a Bug](https://github.com/FaserF/hassio-addons/issues/new?template=bug_report.yml&version_integration=2.4.2&log_information=Please+paste+the+addon+log+output+here%3A%0A%0A)**
