...
Write-Host "    > [Custom] Verifying Wiki.js..." -ForegroundColor Gray
...
if ($procCheck -match "node") {
     ...
     Add-Result -Addon $Addon.Name -Check "ProcessCheck" -Status "WARN" -Message "Node process NOT found (might be waiting for DB)."
}
