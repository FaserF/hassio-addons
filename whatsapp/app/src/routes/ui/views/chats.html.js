                ...
                <div class="chat-container-layout">
                    <div class="chat-list-panel">
                        <div class="chat-list-header" style="display:flex;align-items:center;gap:10px;padding:12px 16px;border-bottom:1px solid var(--border-color);">
                            <div class="search-box-wrapper" style="flex:1;">
                                ...
                                <input type="text" id="chat-search" class="chat-search-input" placeholder="Search chats..." data-i18n-placeholder="chats.search_placeholder" oninput="filterChatList()">
                            </div>
                            <button class="btn btn-primary btn-sm" style="border-radius:50%;width:36px;height:36px;padding:0;flex-shrink:0;display:flex;align-items:center;justify-content:center;" data-i18n-title="chats.start_new_chat" title="Start New Chat" onclick="openNewChatModal()">
                                <i class="fas fa-plus"></i>
                            </button>
                        </div>
                        <div class="chat-list-items" id="chat-list-items">
                            <div class="empty-state" data-i18n="chats.no_conversations">No conversations active yet</div>
                        </div>
                    </div>
                    ...
                    <div class="chat-thread-panel" id="chat-thread-panel">
                        <div class="chat-thread-empty" id="chat-thread-empty">
                            ...
                            <h3 data-i18n="chats.select_chat_title">Select a chat to view messages</h3>
                            <p data-i18n="chats.select_chat_hint">Select a contact or group from the left sidebar to start chatting.</p>
                        </div>
                        ...
                        <div class="chat-thread-active" id="chat-thread-active" style="display: none;">
                            <div class="chat-thread-header" style="display:flex;align-items:center;justify-content:space-between;padding:12px 20px;min-height:62px;width:100%;border-bottom:1px solid var(--border-color);background-color:var(--bg-card);gap:12px;overflow:visible;">
                                <div class="chat-thread-info" onclick="openChatInfoDrawer()" style="display:flex;align-items:center;gap:14px;flex:1;min-width:0;cursor:pointer;" data-i18n-title="chats.view_contact_details" title="Click to view Contact / Group Details">
                                    ...
                                    <div style="flex:1;min-width:0;">
                                        <h4 id="active-chat-name" style="margin:0;font-size:16px;font-weight:700;color:var(--text-main);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" data-i18n="chats.contact_jid">${''}</h4>
                                        <p id="active-chat-jid" style="margin:2px 0 0;font-size:12px;color:var(--text-muted);display:flex;align-items:center;gap:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                            ...
                                            <span id="active-chat-jid-text" data-i18n="chats.jid_details">${''}</span>
                                        </p>
                                    </div>
                                </div>
                                <div style="display:flex;gap:6px;align-items:center;flex-shrink:0;z-index:5;">
                                    <span id="active-chat-header-badges" style="display:inline-flex;gap:6px;align-items:center;"></span>
                                    <button class="btn btn-ghost chat-header-btn" id="chat-search-toggle" data-i18n-title="chats.search_in_chat" title="Search in chat" onclick="toggleChatSearch()"><i class="fas fa-search"></i></button>
                                    <button class="btn btn-ghost chat-header-btn" data-i18n-title="chats.contact_info" title="Contact / Group Info" onclick="openChatInfoDrawer()"><i class="fas fa-info-circle"></i></button>
                                </div>
                            </div>
                            ...
                            <div id="chat-search-bar" style="display:none;padding:8px 16px;background:var(--bg-card);border-bottom:1px solid var(--border-color);">
                                <div class="search-box-wrapper" style="width:100%;">
                                    <i class="fas fa-search search-icon"></i>
                                    <input type="text" id="in-chat-search-input" class="chat-search-input" placeholder="Search in this conversation…" data-i18n-placeholder="chats.search_in_chat" oninput="searchInActiveChat()">
                            ...
                            <div class="chat-thread-footer">
                                ...
                                <form id="chat-message-form" class="chat-message-form" onsubmit="sendChatMessage(event)">
                                    <button type="button" class="chat-icon-btn" data-i18n-title="chats.emoji" title="Emoji" onclick="toggleEmojiPicker(event)"><i class="far fa-smile"></i></button>
                                    <label class="chat-icon-btn" data-i18n-title="chats.attach_file" title="Attach file">
                                        <i class="fas fa-paperclip"></i>
                                        <input type="file" id="chat-file-input" style="display:none;" onchange="sendFileMessage(this)">
                                    </label>
                                    <input type="text" id="chat-message-input" class="chat-message-input" placeholder="Type a message…" data-i18n-placeholder="chats.type_message" autocomplete="off">
                                    <button type="submit" class="chat-send-btn" data-i18n-title="chats.send" title="Send"><i class="fas fa-paper-plane"></i></button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="chat-info-drawer" id="chat-info-drawer" style="display:none;">
                            <div class="drawer-header">
                                <h4 data-i18n="chats.contact_info">Contact Info</h4>
                            ...
                            <div class="drawer-body" id="drawer-body-content">
                                <div class="empty-state"><i class="fas fa-spinner fa-spin"></i> <span data-i18n="chats.loading_info">Loading info…</span></div>
                            </div>
                        </div>
                    </div>
                </div>
