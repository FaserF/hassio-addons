...
if ! bashio::services.available "mysql"; then
	bashio::log.error "This App requires the MariaDB core App 2.0 or newer!"
	bashio::exit.nok "Make sure the MariaDB App is installed and running"
fi
