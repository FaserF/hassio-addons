...
bashio::log.info "Starting AegisBot App initialization..."
...
if [[ "$DB_TYPE" == "postgresql" ]]; then
	...
	export DATABASE_URL="sqlite+aiosqlite:///$DB_DIR/aegisbot.db"
...
bashio::app.auto_migrate_data "aegisbot" || true
# </TEMP_MIGRATION_HELPER:REMOVE_ON_RELEASE>
